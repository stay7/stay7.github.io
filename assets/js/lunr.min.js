...
!(function () {
  ...
  ;(t.version = '0.7.0'),
    ...
    (t.tokenizer.registeredFunctions = { default: t.tokenizer }),
    (t.tokenizer.registerFunction = function (e, n) {
      n in this.registeredFunctions &&
        t.utils.warn('Overwriting existing tokenizer: ' + n),
        (e.label = n),
    ...
    (t.Pipeline.prototype.run = function (t) {
      for (
        var e = [], n = t.length, i = this._stack.length, r = 0;
        n > r;
        r++
      ) {
        for (
    ...
    (t.Index.prototype.add = function (e, n) {
      ...
      for (var s = 0; s < r.length; s++) {
        ...
        this.tokenStore.add(a, { ref: o, tf: h })
      }
    ...
    (t.Index.prototype.idf = function (t) {
      ...
      var n = this.tokenStore.count(t),
        i = 1
      return (
        n > 0 && (i = 1 + Math.log(this.documentStore.length / n)),
        (this._idfCache[e] = i)
      )
    }),
